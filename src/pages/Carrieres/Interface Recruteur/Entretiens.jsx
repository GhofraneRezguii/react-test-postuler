    ...
    return (
        <RecruterLayout>
            ...
            <div className="searchyy-wrapper">
                    ...
                    <div className="parent">
                        <div className="cardd">
                            ...
                            <div className="date-box">
                                <span className="month">{new Date().toLocaleDateString("fr-FR", { month: "long" }).toUpperCase()}</span>
                        ...
                        {showCalendar && (
                            <div className="calendar-popup-overlay" onClick={() => setShowCalendar(false)}>
                                <div className="calendar-popup-card" onClick={e => e.stopPropagation()}>
                                    <button className="closey-btn" onClick={() => setShowCalendar(false)}>×</button>
                                    <Calendar
                ...
                {/* cards */}
                <div className="stackedy-cards" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "30px", marginTop: "50px" }}>
                    {/* card RDV today */}
                    <div className="stacky-card">
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
                            <h4 style={{ fontWeight: "600", marginBottom: "10px", display: "flex", alignItems: "center", gap: "15rem" }}>
                                <span>RDV pour Aujourd'hui</span>
                                <span style={{ color: "#8ac3ff" }}>Total RDV : <span style={{ color: "#8ac3ff" }}>({todayRDVs.length})</span></span>
                            </h4>
                        ...
                        {todayRDVs.length === 0 ? (
                            <p style={{
                                marginTop: "20px", textAlign: "center", fontStyle: "italic", color: "white", textShadow:
                                    `0 0 4px rgba(158, 191, 249, 0.886),
                            0 0 8px rgba(155, 186, 239, 0.975),
                            0 0 12px rgb(190, 210, 247)`,
                                transition: "text-shadow 0.3s ease"
                            }}>Aucun RDV pour aujourd'hui</p>
                        ) : (
                                ...
                                <div key={index} className="cardy">
                                    ...
                                    >
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                                            ...
                                            <div className="editi" onClick={() => openEditModal(rdv)} title="Modifier RDV" style={{ cursor: "pointer" }}>
                                                <EditIcon />
                                            </div>
                                            <div className="deleti" onClick={() => openDeleteModal(rdv)} title="Supprimer RDV" style={{ cursor: "pointer" }}>
                                                <DeleteIcon />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="info-line">
                                        Candidat : <strong>{rdv.nom} {rdv.prenom}</strong>
                                    </div>
                                    <div className="info-line">
                                        Date : <strong>{new Date(rdv.date).toLocaleString("fr-FR", { dateStyle: "short", timeStyle: "short" })}</strong>
                                    </div>
                        ...
                        <div className="stacky-card ally">
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
                                <h4 style={{ fontWeight: "600", marginBottom: "10px", display: "flex", alignItems: "center", gap: "21rem" }}>
                                    <span>Tous les RDV</span>
                                    <span style={{ color: "#8ac3ff" }}>Total RDV : <span style={{ color: "#8ac3ff" }}>({allRDVs.length})</span></span>
                                </h4>
                                ...
                                allRDVs.map((rdv, index) => (
                                    <div key={index} className="cardy">
                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                            <p className="cardy-title" style={{ marginBottom: 0 }}>{rdv.offre}</p>
                        ...
                        {editModalOpen && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div style={{ display: "flex", justifyContent: "flex-end", gap: 150 }}>
                                        <button className="annbtn" onClick={() => setEditModalOpen(false)}>Annuler</button>
                                        <button className="confbtn" onClick={confirmEdit}>Confirmer</button>
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-around", marginTop: 20 }}>
                                        <button className="annbtn" onClick={() => setDeleteModalOpen(false)}>Non</button>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <input
                                        type="text"
                                        value={newRdv.offre}
                                        onChange={(e) => setNewRdv({ ...newRdv, offre: e.target.value })}
                                        style={{ width: "100%", marginBottom: 10 }}
                                    />
                                    ...
                                    <div style={{ display: "flex", justifyContent: "space-between", gap: "20px" }}>
                                        <button className="annbtn" onClick={() => setCreateModalOpen(false)}>Annuler</button>
                                        <button
                                            className="confbtn"
                                            onClick={() => {
