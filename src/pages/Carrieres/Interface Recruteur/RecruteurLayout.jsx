...
function RecruterLayout({ children }) {
  ...
  function getGravatarUrl(email, fallback = "https://i.pinimg.com/736x/2f/5a/44/2f5a44eaa573021b56e018d7376c27af.jpg") {
    const hash = md5(email.trim().toLowerCase());
    return `https://www.gravatar.com/avatar/${hash}?d=${encodeURIComponent(fallback)}`;
  }

  const IconDashboard = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="26" fill="currentColor" className="bi bi-columns-gap" viewBox="0 0 16 16" style={{ marginRight: "8px" }}>
      <path d="M6 1v3H1V1zM1 0a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1zm14 12v3h-5v-3zm-5-1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1zM6 8v7H1V8zM1 7a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1zm14-6v7h-5V1zm-5-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z" />
    </svg>
  );

  const IconSuitcase = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="26" fill="currentColor" className="bi bi-suitcase-lg" viewBox="0 0 16 16" style={{ marginRight: "8px" }}>
  ...
  const IconPeople = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="26" fill="currentColor" className="bi bi-people" viewBox="0 0 16 16" style={{ marginRight: "8px" }}>
      <path d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1zm-7.978-1L7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002-.014.002zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0M6.936 9.28a6 6 0 0 0-1.23-.247A7 7 0 0 0 5 9c-4 0-5 3-5 4q0 1 1 1h4.216A2.24 2.24 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816M4.92 10A5.5 5.5 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4" />
    </svg>
  );

  const IconEnvelope = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="26" fill="currentColor" className="bi bi-envelope-at" viewBox="0 0 16 16" style={{ marginRight: "8px" }}>
  ...
  const IconPersonVCard = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="26" fill="currentColor" className="bi bi-person-vcard" viewBox="0 0 16 16" style={{ marginRight: "8px" }}>
  ...
  const [editFields, setEditFields] = useState({ nom: false, prenom: false, email: false });
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setAdminImg(reader.result); // met à jour l’image affichée
      };
        ...
        >
          <img
            ...
            onError={(e) => {
              ...
              e.target.src =
                "https://i.pinimg.com/736x/2f/5a/44/2f5a44eaa573021b56e018d7376c27af.jpg";
            }}
            style={{
              borderRadius: "50%",
              objectFit: "cover",
          ...
          <nav className="navbar recruter-navbar bg-body-tertiary mb-3" >
            <div className="container-fluid" style={{ display: "flex", alignItems: "center", flexWrap: "nowrap" }}>
              <Link to="/" style={{ display: "flex", alignItems: "center", marginRight: "15px", flexDirection: "column", textDecoration: "none", }} aria-label="Accueil">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-house-fill home-icon" viewBox="0 0 16 16">
              ...
              <button className="notification" aria-label="Notifications" style={{ marginRight: "60px", marginLeft: "10px", paddingRight: "25px" }}>
                <svg className="bell" viewBox="0 0 448 512" aria-hidden="true" focusable="false" width="16" height="16">
                  <path
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ marginBottom: 10, position: "relative", display: "inline-block" }}>
                        <img src={adminImg} alt="admin" style={{ width: 80, borderRadius: "50%" }} />
                        ...
                        >
                         <span style={{fontWeight:"800" ,fontSize:"25px",color:"white"}}>+</span> 
                        </button>
                      ...
                      {['nom', 'prenom', 'email'].map((field) => (
                        <div key={field} style={{ marginBottom: 10 }}>
                          ...
                          {editFields[field] ? (
                            ...
                            <span style={{ marginLeft: 10 }}>{adminData[field]}</span>
                          )}
                          <FaEdit className="comticon"
                            style={{ fontSize: "1.3rem", marginLeft: 10, cursor: "pointer" }}
                            onClick={() => setEditFields({ ...editFields, [field]: !editFields[field] })}
                          />
                        </div>
                      ))}

                      <button className="mdp-btn"
                        onClick={() => setEditPassword(!editPassword)}
                        style={{ margin: "15px 0", padding: "8px 12px", color: "white", borderRadius: 5 }}
                      >
                      ...
                      {editPassword && (
                        <div>
                          ...
                          />
                          {errors.current && <div style={{ color: "red" }}>{errors.current}</div>}
                      ...
                      <div style={{ marginTop: 20, display: "flex", justifyContent: "space-between" }}>
                        <button className="annbtn" onClick={() => setShowModal(false)}>Annuler</button>
                        <button className="confbtn" onClick={handleConfirm}>Confirmer</button>
                      </div>
                    </div>
                  </div>
                )}
