      ...
      <div className="cards-container">
        ...
        <div className="card">
          <div className="card-header">
            ...
            <i className="bi bi-briefcase icon-right" style={{ marginLeft: "12px" }}></i>
          </div>
          <div className="info-line">Nombre d'Offres : <strong>120</strong></div>
          <div className="info-line"><strong className="Noffres-act">8</strong> Actives, <strong className="Noffres-exp">4</strong> Expirées</div>
          <div className="info-line">Dernière mise à jour : <strong>14 Juil 2025</strong></div>
          <Link to="/offres" className="go-corner" style={{ textDecoration: "none" }}>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <i className="bi bi-mortarboard-fill icon-right" style={{ marginLeft: "12px" }}></i>
          </div>
          <div className="info-line">Nombre de Candidats : <strong>85</strong></div>
          <div className="info-line">Acceptés : <strong>35</strong></div>
          <div className="info-line">Refusés : <strong>50</strong></div>
          <Link to="/candidats" className="go-corner" style={{ textDecoration: "none" }}>
            <div className="go-arrow">→</div>
          </Link>
        </div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <i className="bi bi-person-fill-up icon-right" style={{ marginLeft: "12px" }}></i>
          </div>
          <div className="info-line">Cette semaine : <strong>2</strong></div>
          <div className="info-line">Ce mois : <strong>9</strong></div>
          <Link to="/nouvelles-candidatures" className="go-corner" style={{ textDecoration: "none" }}>
            <div className="go-arrow">→</div>
          </Link>
        </div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <i className="bi bi-stopwatch icon-right" style={{ marginLeft: "12px" }}></i>
          </div>
          <div className="info-line" style={{ fontSize: "28px", textAlign: "center" }}>
            <strong>19</strong>
          </div>
          <div className="info-line" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "15px" }}>
          ...
          <Link to="/en-attente" className="go-corner" style={{ textDecoration: "none" }}>
            <div className="go-arrow">→</div>
          </Link>
        </div>
      </div>
