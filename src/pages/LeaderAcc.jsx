    ...
    <>
      <div className="background-containerfk ST">
        ...
        <div className="contentfk">
          ...
          <h1 className="titlefk SJ">
            "User Club" de Fininfo Solutions<br></br> réunit les leaders
      ...
      <div className="cards-containervl">
        <div className="card-itemvl">
          ...
          <p className="card-subtitlevl">
            Présenter nos dernières avancées à nos clients marocains
          </p>
        </div>
      ...
      <div className="two-column-containerQE">
        ...
        <div className="right-columnQE ">
          ...
          <p className="section-textQE">
            Les acteurs de premier plan du secteur financier se sont réunis au
            prestigieux Hôtel Four Seasons de Casablanca pour l'événement
            exclusif "user club", organisé par{" "}
            <strong>FININFO SOLUTIONS.</strong>. Cet événement a rassemblé des
            représentants éminents de banques et d'institutions financières pour
            une journée de partage d'expertise et d'exploration des tendances
            émergentes dans le domaine financier.
          </p>
        </div>
        ...
        {isOpen && (
          <div className="video-modal sdf">
            <div className="video-card ghj">
              <button className="close-btn fds" onClick={handleToggle}>
                ×
              </button>
              <iframe
                width="100%"
      ...
      <div className="galerie-container">
        <div className="galerie-left">
          ...
          <p>
            Au cours de cette journée immersive, les participants ont eu
            l'occasion d'assister à des présentations détaillées des
            fonctionnalités de nos logiciels , des démonstrations pratiques et
            des sessions de questions-réponses animées par nos experts . De
            plus, l'événement a permis aux participants de développer leur
            réseau professionnel et d'établir des contacts précieux au sein de
            l'industrie.
          </p>
        </div>
      ...
      <div className="Suites-finlp szl lgd">
        ...
        <h4>
          Que nous remercions chaleureusement d'avoir participé à notre "User
          club"
        </h4>
      </div>
      <CardsPartenaires />
  ...
  const cardData = [
    {
      ...
      image:
        "https://i.pinimg.com/1200x/86/fc/ba/86fcba3869a8b159e69dac6007a09926.jpg",
      text: "",
    },
    {
      title: "",
      image:
        "https://fininfosolutions.com/wp-content/uploads/2024/02/DSC_2902-2048x1367.jpg",
    ...
    },
    {
      title: "",
      image:
        "https://fininfosolutions.com/wp-content/uploads/2024/02/DSC_2886-2048x1367.jpg",
...
const ArticlesCards = () => {
  const articles = [
    {
      image:
        "https://fininfosolutions.com/wp-content/uploads/2024/02/DSC_2881.jpg",
      title:
        "La fintech Fininfo Solutions présente ses dernières avancées à ses clients marocains",
      link: "https://lnt.ma/la-fintech-fininfo-solutions-presente-ses-dernieres-avancees-a-ses-clients-marocains/",
    },
    {
      image:
        "https://fininfosolutions.com/wp-content/uploads/2024/02/DSC_2921.jpg",
      title:
        "Fares GAIED, CEO FININFO Solutions : « Devenir un acteur de référence sur l’espace du post marché au Maroc »",
